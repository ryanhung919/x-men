...
export const tasksFixtures = {
  designHomepage: {
    ...
    get deadline() { return createSGTDateRange().yesterday; },
    notes: '',
    parent_task_id: null,
  ...
  budgetReport: {
    ...
    project_id: projectsFixtures.alpha.id,
    get deadline() { return createSGTDateRange().today; },
    notes: '',
    parent_task_id: null,
    recurrence_interval: 0,
    recurrence_date: null,
  ...
  teamMeeting: {
    ...
    get deadline() { return createSGTDateRange().tomorrow; },
    notes: '',
    parent_task_id: null,
  ...
  marketingCampaign: {
    ...
    project_id: projectsFixtures.beta.id,
    get deadline() { return createSGTDateRange().in14Days; },
    notes: '',
    parent_task_id: null,
    recurrence_interval: 0,
    recurrence_date: null,
  ...
  analyticsDashboard: {
    ...
    get deadline() { return createSGTDateRange().in15Days; },
    notes: '',
    parent_task_id: null,
    recurrence_interval: 0,
    recurrence_date: null,
